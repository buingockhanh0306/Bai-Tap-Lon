...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="#66CCFF" BorderColor="#66CCFF" DataSourceID="SqlDataSource1" Width="240px" Height="266px">
    <Columns>
        <asp:TemplateField HeaderText="Chủ đề sách" SortExpression="Ten_chu_de">
            ...
            <ItemTemplate>
                ...
                &nbsp;
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "~/Pages/Defaut.aspx?Mcd="+Eval("Mcd")+"&TenChuDe="+Eval("Ten_chu_de") %>' Text='<%# Eval("Ten_chu_de") %>'></asp:HyperLink>
            </ItemTemplate>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:QLBanSachConnectionString1 %>" SelectCommand="Select CD.Mcd, CD.Ten_chu_de + '  (' + ltrim(str(count(S.Mcd)))+')' Ten_chu_de
from CHU_DE CD
