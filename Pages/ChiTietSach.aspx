                    ...
                    <table class="auto-style8">
                        ...
                        <tr>
                            <td class="auto-style11">Đơn giá:&nbsp;
                                <asp:Label ID="Label8" runat="server" ForeColor="Red" Text='<%# Eval("Don_gia", "{0:0,0}")+" VNĐ" %>'></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style11">
                                <asp:HyperLink ID="HyperLink1" runat="server" ImageUrl='<%# "~/image/nut_chonmua.gif" %>' NavigateUrl='<%# "MuaHang.aspx?Ms="+Eval("Ms") %>'>HyperLink</asp:HyperLink>
                                <br />
                            </td>
                        </tr>
                        <tr>
